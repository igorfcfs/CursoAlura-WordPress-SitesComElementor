<?php function businessup_scripts() {
  ...
  wp_enqueue_script('swiper', get_template_directory_uri() . '/js/swiper-bundle.min.js', array('jquery'));
...
function businessup_admin_style() {
  ...
  wp_enqueue_script( 'businessup-admin-script', get_template_directory_uri() . '/js/businessup-admin-script.js', array( 'jquery' ), '', true );
    wp_localize_script( 'businessup-admin-script', 'businessup_ajax_object',
